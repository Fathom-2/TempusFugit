...
> **Note:** For the best performance and Distant Horizons compatibility, TempusFugit was developed and tested using **Java 21**, **8GB RAM**, and the following additional JVM arguments: `-XX:+UseZGC -XX:+ZGenerational`. In the **CurseForge App**, open **My Modpacks**, click **TempusFugit**, then click the **⋮** (three dots) next to the orange **Play** button and select **Profile Options** to configure your RAM, Java version, and additional JVM arguments.
